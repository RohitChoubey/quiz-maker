                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7 ays_divider_left">
                                            <select class="ays-text-input ays-text-input-short">
                                                ...
                                                <option value="fill"><?php echo __('Fill',$this->plugin_name)?></option>
                                                <option value="contain"><?php echo __('Contain',$this->plugin_name); ?></option>
                                                <option value="scale-down"><?php echo __('Scale-down',$this->plugin_name); ?></option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7 ays_divider_left">
                                            ...
                                            <div class="col-sm-12 ays_toggle_target ays_divider_top" style="margin-top: 10px; padding-top: 10px;">
                                                ...
                                                <input type="text" class="ays-text-input" id='ays_answers_box_shadow_color' data-alpha="true" data-default-color="#000000" value="#000"/>
                                            </div>
                                        </div>
