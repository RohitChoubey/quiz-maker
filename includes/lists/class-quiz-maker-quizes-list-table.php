...
class Quizes_List_Table extends WP_List_Table{
    ...
    public function add_or_edit_quizes(){
        ...
        if( isset($_POST["quiz_action"]) && wp_verify_nonce( sanitize_text_field( $_POST["quiz_action"] ), 'quiz_action' ) ){
            ...
            $image                      = sanitize_text_field( $_POST['ays_quiz_image'] );
            ...
            $enable_logged_users_mas    = !isset($_POST['ays_enable_logged_users_message']) ? null : sanitize_text_field( $_POST['ays_enable_logged_users_message'] );
            ...
            $author = isset($_POST['ays_quiz_author']) ? sanitize_text_field( $_POST['ays_quiz_author'] ) : '';
            ...
            $answers_font_size          = (isset($_POST['ays_answers_font_size']) && sanitize_text_field( $_POST['ays_answers_font_size'] ) != "") ? sanitize_text_field( $_POST['ays_answers_font_size'] ) : "";
            ...
            $submit_redirect_delay = !isset($_POST['ays_submit_redirect_delay']) ? '' : sanitize_text_field( $_POST['ays_submit_redirect_delay'] );
            ...
            // Question Font Size
            $question_font_size = (isset($_POST['ays_question_font_size']) && $_POST['ays_question_font_size'] != '') ? absint(intval($_POST['ays_question_font_size'])) : '16';
            ...
            $question_mobile_font_size = ( isset($_POST['ays_question_mobile_font_size']) && $_POST['ays_question_mobile_font_size'] != "" ) ? absint( sanitize_text_field( $_POST['ays_question_mobile_font_size'] ) ) : 16;

            // Answer font size | On mobile
            $answers_mobile_font_size = ( isset($_POST['ays_answers_mobile_font_size']) && $_POST['ays_answers_mobile_font_size'] != "" ) ? absint( sanitize_text_field( $_POST['ays_answers_mobile_font_size'] ) ) : 15;
            ...
            $options = array(
                ...
                'questions_count'               => sanitize_text_field( $_POST['ays_questions_count'] ),
